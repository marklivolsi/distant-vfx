...
FMP_SPLASH_DB = environ.get('FMP_SPLASH_DB')
...
FMP_SHOTS_LAYOUT = environ.get('FMP_SHOTS_LAYOUT')
FMP_SPLASH_LAYOUT = environ.get('FMP_SPLASH_LAYOUT')
...
FMP_MIDNIGHT_CHECKUP_SCRIPT = environ.get('FMP_MIDNIGHT_CHECKUP_SCRIPT')
